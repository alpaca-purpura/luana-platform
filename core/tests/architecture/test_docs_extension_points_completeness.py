"""Architecture fitness: docs/extension-points.md §1-§5 completeness.

V-F-docs-1. Verifies docs/extension-points.md ships with all required sections:
...
DOCS_FILE = ROOT / "docs" / "extension-points.md"
...
def test_docs_has_vitalia_examples() -> None:
    ...
    assert _check(text, r"vitalia"), (
        "docs/extension-points.md missing 'vitalia' examples.\n"
...
def test_docs_has_comunify_examples() -> None:
    ...
    assert _check(text, r"comunify"), (
        "docs/extension-points.md missing 'comunify' examples.\n"
...
def test_docs_has_lupulo_examples() -> None:
    ...
    assert _check(text, r"lupulo"), (
        "docs/extension-points.md missing 'lupulo' examples.\n"
...
def test_docs_has_no_ep19_literal() -> None:
    ...
    assert _check(text, r"no ep-?19"), (
        "docs/extension-points.md missing 'NO EP-19' literal string.\n"
...
def test_docs_has_vertical_agent_recipe() -> None:
    ...
    assert _check(text, r"vertical.?agent|treatment_agent"), (
        "docs/extension-points.md missing vertical agent recipe section.\n"
...
def test_docs_has_cross_brand_learning_principle() -> None:
    ...
    assert _check(text, r"cross-brand learning|graduate to core"), (
        "docs/extension-points.md missing §5 cross-brand learning principle.\n"
