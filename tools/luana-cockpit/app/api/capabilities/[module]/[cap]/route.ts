/**
 * GET   /api/capabilities/{module}/{cap}?brand=vitalia   → { capability }
 * PATCH /api/capabilities/{module}/{cap}?brand=vitalia
...
function capYamlPath(brand: string, module: string, slug: string): string {
...
export async function GET(
  ...
  try {
    const absPath = capYamlPath(brand, moduleName, capSlug);
