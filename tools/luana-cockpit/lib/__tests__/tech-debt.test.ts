...
const REAL_FILE = path.resolve(__dirname, '../../../../docs/process/tech-debt.md');
...
describe('parseTechDebt · smoke contra el archivo real', () => {
  it('parsea docs/process/tech-debt.md sin crashear (hoy 0 filas TD-N reales)', async () => {
