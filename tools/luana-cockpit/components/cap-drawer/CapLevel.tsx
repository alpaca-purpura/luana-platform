 ...
 *
 * Modelo de niveles (cockpit-capability-levels-proposal.md · ratificado Chris 2026-06-06,
 ...
 * por defecto (lo que Chris más mira); N3/N4 colapsan (referencia técnica bajo demanda).
 */
