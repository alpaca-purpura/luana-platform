 ...
 * y dispara `onEvent` cuando un archivo del SSoT brand cambia.
 *
 * Convenciones:
...
/**
 * Suscribe a SSE /api/watch?brand=X y llama `onEvent` por cada cambio.
...
export function useFileWatch(
  ...
  useEffect(() => {
    ...
    const url = `/api/watch?brand=${encodeURIComponent(brand)}`;
