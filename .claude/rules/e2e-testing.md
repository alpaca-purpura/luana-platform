...
**SSoT skill: `playwright-expert`** (auto-loads on any e2e/playwright/smoke trigger). Carga el skill ANTES de tocar `{brand}/frontend/e2e/**` o `{brand}/frontend/playwright.config.ts` o `.github/workflows/e2e-tests.yml`.
