...
|---|---|---|---|
| Root | `CLAUDE.md` | **≤200 líneas** | Siempre (cualquier worktree) |
| Brand overlay | `{brand}/CLAUDE.md` | **≤150 líneas** | Auto cuando cwd cae dentro de `{brand}/` |
...
- Root o brand overlay superan su cap (200/150 líneas) → leer qué mover y adónde.
...
- ❌ Root `CLAUDE.md` >200 líneas o brand overlay >150 líneas (mover detalle a `docs/rules-detail/` o `{brand}/docs/domains/`)
...
- `vitalia/CLAUDE.md` — ejemplo overlay activo
