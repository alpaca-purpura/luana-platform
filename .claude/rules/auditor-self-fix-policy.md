...
└─ NO → ¿El fix es una FEATURE entera nunca diseñada? (> ~2 archivos nuevos de
        ...
        └─ NO → CARRIL R (RESPONSABLE · default): el auditor lo arregla él mismo.
                ...
                live-verify dev-app (≥1 write real + leer logs + confirmar efecto).
...
## Regla cardinal v4.2 (histórica — routing por defecto SUPERSEDED por v5 arriba)

### Decision tree (3 carriles)
