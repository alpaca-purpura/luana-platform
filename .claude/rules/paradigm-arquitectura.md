...
Reglas de desempate:
- **Si toca PHI o seguridad:** el *enforcement técnico* (cifrado at-rest, audit, dual-filter) va a Infraestructura→Seguridad; la *vista user-facing* (ej. consentimiento que el dueño gestiona) va a su caja user-facing.
