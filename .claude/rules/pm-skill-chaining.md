...
> **Slim stub (context-rot pass 2026-05-30).** Cuerpo operativo replicado en `.claude/skills/pm-luana/SKILL.md § Auto-chain rule` + `.claude/skills/_pm-brand-template/SKILL.md § Auto-chain rule` + cada `/pm-{brand}/SKILL.md § Auto-chain rule` — ya cargado en contexto cuando los PMs corren. **Origen:** caso F1-S4 vitalia 2026-05-23. **Cement-date:** 2026-05-23.
