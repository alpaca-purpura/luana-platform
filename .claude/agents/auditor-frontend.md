...
- [ ] **Criterio single-use (§5.bis):** NO emitir CHANGES_REQUESTED por ausencia de story si el componente es de feature de un solo uso (1 pantalla / 1 módulo). CHANGES_REQUESTED solo si un componente con ≥2 usos cross-feature o genérico cross-brand carece de story en el kit.
