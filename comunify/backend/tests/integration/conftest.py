...
Usage:
    POSTGRES_DSN="postgresql+asyncpg://postgres:postgres@localhost:5432/comunify_test" \
        pytest tests/integration/ -m integration -v

Mirrors vitalia/backend/tests/integration/conftest.py (Story 11 precedent).
"""
...
POSTGRES_DSN = os.getenv(
    "POSTGRES_DSN",
    "postgresql+asyncpg://postgres:postgres@localhost:5432/comunify_test",
)
