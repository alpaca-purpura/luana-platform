...
active_stories:
  - id: comunify-design-system-tailwind-v4-tokens
    state: idea
    surface: [frontend, design-system]
    opened: 2026-05-18
    hotfix: true
    repro_verified: true
    blocks: [comunify-warning-token-contrast-fix]
    origin: /pm-comunify autonomous run 2026-05-18 — validators deferred audit revealed silent ship (cement story shipped with comunify-* utility classes never generated by Tailwind v4; CSS bundle has :root vars only)
  - id: comunify-warning-token-contrast-fix
    state: idea
    surface: [frontend, design-system]
    opened: 2026-05-18
    blocked_by: [comunify-design-system-tailwind-v4-tokens]
