/**
 * Architecture test — HB-106 (A-1): no NATIVE `<select>` in nicolify/frontend/src
 ...
 *
 * Baseline MEASURED 2026-06-24 (HB-106 seed): 1 occurrence across 1 file. This
 * is pre-existing and will be migrated by the studio adoption story
 * (nicolify-r0-design-system-adoption); the lock simply prevents NEW native selects.
 *
