...
/**
 * TenantOption — agency row molecule for the dropdown list.
 * nicolify-r0-shell T-2 — port from vitalia TenantOption.tsx, re-themed to Nicolify.
 *
...
/**
 * TenantOption — row component for the agency list inside the dropdown.
 * Server Component.
 */
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <span className="truncate text-xs text-muted-foreground">{tenant.city}</span>
      </div>
      ...
      {active ? (
        <>
          ...
          <span className="sr-only">Agencia activa</span>
        </>
      ) : null}
    </div>
  );
