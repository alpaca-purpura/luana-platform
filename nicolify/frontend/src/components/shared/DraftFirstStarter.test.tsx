...
describe("DraftFirstStarter — 2-camino starter", () => {
  it("renders both action buttons", () => {
    render(<DraftFirstStarter onGenerateDraft={vi.fn()} onStartBlank={vi.fn()} />);
  ...
  it("calls onGenerateDraft when Path A button clicked", () => {
    ...
    render(<DraftFirstStarter onGenerateDraft={onGenerateDraft} onStartBlank={vi.fn()} />);
  ...
  it("calls onStartBlank when Path B button clicked", () => {
    ...
    render(<DraftFirstStarter onGenerateDraft={vi.fn()} onStartBlank={onStartBlank} />);
  ...
  it("respects agentName prop", () => {
    render(
      <DraftFirstStarter onGenerateDraft={vi.fn()} onStartBlank={vi.fn()} agentName="TestAgent" />,
    );
