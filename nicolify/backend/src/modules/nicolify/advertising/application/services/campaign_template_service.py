...
from src.modules.nicolify.advertising.domain.enums import objective_label_es
from src.modules.nicolify.advertising.infrastructure.repositories.campaign_template_repository import (
