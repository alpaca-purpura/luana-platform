...
from src.modules.nicolify.advertising.application.dto.association_dto import AssociationDTO
...
from src.modules.nicolify.advertising.infrastructure.repositories.meta_catalog_repository import (
    CampaignSnapshot,
    MetaCatalog,
    MetaCatalogRepository,
)
from src.modules.nicolify.advertising.infrastructure.repositories.metrics_repository import (
    MetricsRepository,
)
