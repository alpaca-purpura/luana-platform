---
story_id: nicolify-r0-shell-layout-splitter
brand: nicolify
type: ui-story
state: idea
release: R0
...
cap_target: null
cap_change_type: new
depends_on: [nicolify-r0-design-system-tokens]
r0_order: 4
...
# nicolify-r0-shell-layout-splitter — checkpoint

## Goal

ShellOrganismLayout dual-mode 50/50 con splitter resizable de 3 estados (chat-collapsed/narrow/50-50, drag + snaps + C/R/F). Boundary dynamic(ssr:false) + store SSR-safe (G2 ADR-006). Skeleton store-free.
