...
kit_alignment_2026_06_24:
  ...
  next: "DECISIÓN Chris (nueva info): los 14 divs NO se cierran limpio en abel → recomiendo APPROVE + rutear a design-system-adoption (dueña del kit+scanner) → demo gate #37 (Chris live) → merge. Baseline queda 32 (los 7 ya migrados). Alternativas presentadas a Chris."
