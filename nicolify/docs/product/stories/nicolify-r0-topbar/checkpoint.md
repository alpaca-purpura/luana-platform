...
# nicolify-r0-topbar — checkpoint

## Goal

TopBarGlobal: LogoMark (svg claro/oscuro real) a la izquierda + TenantSwitcher (agencia, a la DERECHA) + ThemeToggle. role=banner. Mockup ratificado: shell.html.
