...
test.describe("visual goldens — rail state (F1-S5)", () => {
  ...
  test("valeria rail light 1280x800 matches", async ({
    valeriaRailPage,
  }) => {
    const pom = new ValeriaSidebarPage(valeriaRailPage);
    await pom.goto({ valeriaState: "rail", shellMode: "agentic", theme: "light" });
    await expect(pom.sidebar).toBeVisible();
    await expect(valeriaRailPage).toHaveScreenshot("valeria-rail-1280x800-light.png", {
      fullPage: false,
    });
  });

  test("valeria rail dark 1280x800 matches", async ({
    valeriaRailPage,
  }) => {
    const pom = new ValeriaSidebarPage(valeriaRailPage);
    await pom.goto({ valeriaState: "rail", shellMode: "agentic", theme: "dark" });
    await expect(pom.sidebar).toBeVisible();
    await expect(valeriaRailPage).toHaveScreenshot("valeria-rail-1280x800-dark.png", {
      fullPage: false,
    });
  });
});
...
test.describe("visual goldens — full state (F1-S5)", () => {
  ...
  test("valeria full light 1280x800 matches", async ({
    valeriaFullPage,
  }) => {
    const pom = new ValeriaSidebarPage(valeriaFullPage);
    await pom.goto({ valeriaState: "full", shellMode: "agentic", theme: "light" });
    await expect(pom.sidebar).toBeVisible();
    await expect(valeriaFullPage).toHaveScreenshot("valeria-full-1280x800-light.png", {
      fullPage: false,
    });
  });

  test("valeria full dark 1280x800 matches", async ({
    valeriaFullPage,
  }) => {
    const pom = new ValeriaSidebarPage(valeriaFullPage);
    await pom.goto({ valeriaState: "full", shellMode: "agentic", theme: "dark" });
    await expect(pom.sidebar).toBeVisible();
    await expect(valeriaFullPage).toHaveScreenshot("valeria-full-1280x800-dark.png", {
      fullPage: false,
    });
  });
});
...
test.describe("visual goldens — collapsed state (F1-S5)", () => {
  ...
  test("valeria collapsed light 1280x800 matches", async ({
    ...
    const pom = new ValeriaSidebarPage(valeriaRailPage);
    await pom.goto({ valeriaState: "collapsed", shellMode: "web", theme: "light" });
    await expect(valeriaRailPage).toHaveScreenshot("valeria-collapsed-1280x800-light.png", {
      fullPage: false,
    });
  });
  ...
  test("valeria collapsed dark 1280x800 matches", async ({
    ...
    const pom = new ValeriaSidebarPage(valeriaRailPage);
    await pom.goto({ valeriaState: "collapsed", shellMode: "web", theme: "dark" });
    await expect(valeriaRailPage).toHaveScreenshot("valeria-collapsed-1280x800-dark.png", {
      fullPage: false,
    });
  });
});
...
test.describe("visual goldens — history search states (F1-S5)", () => {
  ...
  test("valeria history search active 1280x800 matches", async ({
    ...
    await expect(valeriaFullPage).toHaveScreenshot("valeria-history-search-1280x800-light.png", {
      fullPage: false,
    });
  });
  ...
  test("valeria history empty state 1280x800 matches", async ({
    ...
    await expect(valeriaFullPage).toHaveScreenshot("valeria-history-empty-1280x800-light.png", {
      fullPage: false,
    });
  });
});
...
test.describe("visual goldens — mobile drawer (F1-S5)", () => {
  ...
  test("valeria mobile drawer open 375x667 matches", async ({
    ...
    await expect(valeriaMobilePage).toHaveScreenshot("valeria-mobile-drawer-open-375x667.png", {
      fullPage: false,
    });
  });
  ...
  test("valeria mobile drawer closed 375x667 matches", async ({
    ...
    await expect(valeriaMobilePage).toHaveScreenshot("valeria-mobile-drawer-closed-375x667.png", {
      fullPage: false,
    });
  });
});
