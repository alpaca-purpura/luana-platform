/**
 * AgentActivityStream.test.tsx — Unit tests for AgentActivityStream.
 *
 * Tests:
...
describe("AgentActivityStream — collapsed state", () => {
  beforeEach(() => {
    mockExpanded = false;
...
describe("AgentActivityStream — expanded state (test_8_last_events_scrollable)", () => {
  beforeEach(() => {
    mockExpanded = true;
    mockToggle.mockReset();
  });
...
describe("AgentActivityStream — empty events", () => {
  beforeEach(() => {
    mockExpanded = true;
  });
