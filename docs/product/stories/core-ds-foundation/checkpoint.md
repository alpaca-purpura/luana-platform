...
owner: /pm-luana
state: developing
phase: AWAIT_CHRIS_VERIFY                            # T-2 batch 1+2+3+4 = 63 componentes en Storybook :6007 (200/200 render-smoke verde, verificado por mí con Chrome). Set NO-shell COMPLETO. Falta SOLO el shell organism (pase propio).
next_action: "Chris revisa los 63 en Storybook :6007 (per-component review) · luego SHELL organism (pase aparte) · 3 src bugs flaggeados (ver § Src bugs) → /pm-luana triage ticket aparte"
