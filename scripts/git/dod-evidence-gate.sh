...
# la evidencia sea VERDADERA — eso lo dan el demo_signoff humano + el auditor que ejerce
...
if [ -n "${violations}" ]; then
  ...
  echo "GET 200 / e2e mockeado NO cuentan. Ejercé la acción real en dev-app."
